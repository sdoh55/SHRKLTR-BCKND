...
import calc.auth.SecurityContext;
import calc.auth.SimpleConnectionSignUp;
import calc.auth.SimpleSignInAdapter;
	...
	public UserIdSource getUserIdSource() {
		return new UserIdSource() {
			...
			public String getUserId() {
				return String.valueOf(SecurityContext.getCurrentUser().getUserId());
			}
		};
	}
